...
const HelpingClub = () => {
  ...
  const calculatePrice = () => {
    ...
    const basePrice = priceCalc.workType === 'Assignment' ? 15 : 12; // ₹50 for Assignment, ₹40 for Notebook
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Assignment" className="bg-gray-800">Assignment (₹15/page base)</option>
                    <option value="Notebook" className="bg-gray-800">Notebook (₹12/page base)</option>
                  </select>
                </div>
